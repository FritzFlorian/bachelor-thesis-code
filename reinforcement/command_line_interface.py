...
class CommandLineInterface:
    ...
    def __init__(self, nn_class_name=None, training_work_directory=None, ai_client=False, ai_client_weights_file=None,
                 ...
                 training_master_port=definitions.TRAINING_MASTER_PORT,
                 training_master=False, selfplay_slave=False):
    ...
    def _execute_training_master(self):
        print('Executing Training Master with work directory "{}", on port "{}".'.format(self.work_dir, self.port))

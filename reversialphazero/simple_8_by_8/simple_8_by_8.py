...
# This code will not execute with the current project structure.
# It is here for legacy reasons, so I can look up settings when writing about this
# experiment in my thesis!
# WARNING - WARNING - WARNING
